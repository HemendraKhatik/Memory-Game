function randomRange() {
  ...
  const guessNumber = Math.floor(Math.random() * (987666 - 456722 + 1) + 456722);
  ...
  document.querySelector('#message').innerHTML = "Page will reload in 5 seconds";
...
function check(){
	if(document.querySelector('#userInput').value  === localStorage.getItem('guessNumber')){
		...
		if(match > 0){
			swal("Oops you were almost there ", match +" digits matched " + "Please Try Again!", "warning");
		}
		else{
